...
import AdminLoginButtonIcon from "../../../assets/icon/adminLogin.png";
...
import UserOptionalAuthHeadline from "../../user/userAuthenticationSection/UserOptionalAuthHeadline";
            ...
            <div className="w-full flex-1 mt-8">
              <div className="mx-auto max-w-xs">
                <form onSubmit={handleSubmit}>
                  ...
                  >
                    <img src={AdminLoginButtonIcon} width="30px" height="30px" alt="" />
                    <UserAuthenticationButtonText authButtonText="Login" />
                  </button>
                </form>

                <UserResetPasswordRedirectionLink
                  redirectionLink="/users/OTP-verification"
                  redirectionText="Reset Password"
                  redirectionHeadline="Forget Password ?"
                />

                <UserOptionalAuthHeadline optionalAuthHeadlineText="Welcome to {appName} Administration" />
